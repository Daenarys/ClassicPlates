...
function CpNamePlateBorderTemplateMixin:SetBorderSizes(borderSize, borderSizeMinPixels, upwardExtendHeightPixels, upwardExtendHeightMinPixels)
...
function CpNamePlateBorderTemplateMixin:UpdateSizes()
